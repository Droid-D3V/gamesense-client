...
public class MessageBus {
    ...
    public static String watermark = ChatFormatting.GRAY + "[" + ChatFormatting.WHITE + "Game" + ChatFormatting.GREEN + "Sense" + ChatFormatting.RED + "+2" + ChatFormatting.GRAY + "] " + ChatFormatting.RESET;
